defmodule PomodexWeb.UserAuthTest do
  ...
  @remember_me_cookie "_pomodex_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PomodexWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PomodexWeb.Endpoint.subscribe(live_socket_id)
